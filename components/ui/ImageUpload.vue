<template>
  <div
    class="relative w-full h-32 border-2 border-dashed border-base-300 rounded-box flex items-center justify-center overflow-hidden hover:border-primary transition-colors bg-base-200/50 group cursor-pointer"
    @click="triggerUpload"
  >
    <input
      type="file"
